...
module.exports = function exec(params){
     var code = parseInt(params.deviceType.identifier) + parseInt(params.state.value);
      var j = 0;
    var interval = setInterval(interval_func(code,j), waitTimeBetweenSignals);
  }
function interval_func(code_tosend,increment){
  console.log(code_tosend)
  			rfEmitter.sendCode(code_tosend, {pin: 0})
